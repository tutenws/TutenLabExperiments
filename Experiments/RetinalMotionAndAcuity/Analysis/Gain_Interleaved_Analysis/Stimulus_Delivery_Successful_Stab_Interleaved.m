%%%%%
% For INTERLEAVED STABILIZED trials only
...
expParameters.stimulusTrackingGain = 1;
...
save([stabilizedDir filesep linkFile '_DeliverySuccessGain1.mat'], 'deliveryCorrect');
save([analysisDir filesep linkFile '_DeliverySuccessGain1.mat'], 'deliveryCorrect');
save ([analysisDir filesep linkFile '_acuityDataGain1.mat'], 'expParameters', 'correctVector', 'offsetVector', 'responseVector', 'testSequence');